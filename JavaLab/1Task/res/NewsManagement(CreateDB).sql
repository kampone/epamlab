...
CREATE SEQUENCE Authors_AUTHOR_ID_SEQ START WITH 6 NOCACHE ORDER ;

CREATE SEQUENCE Comments_COMMENT_ID_SEQ START WITH 6 NOCACHE ORDER ;

CREATE SEQUENCE News_NEWS_ID_SEQ START WITH 6 NOCACHE ORDER ;

CREATE SEQUENCE Tags_TAG_ID_SEQ START WITH 6 NOCACHE ORDER ;

CREATE SEQUENCE Users_USER_ID_SEQ START WITH 6 NOCACHE ORDER ;