...
<div class="container" id="rightcol">
	<form:form commandName="comment"
		action="/news-admin/current/add-comment" method="post">
 ...
 --%>
		<input type="hidden" name="news.creationDate"
			value="${news.creationDate}" />
		...
		<c:forEach var="current_comment" items="${news.commentList}">
			...
			<div align="right">
				<a href="/news-admin/current/delete_comment/${current_comment.commentId}">x</a>
			</div>
			<div align="left">
